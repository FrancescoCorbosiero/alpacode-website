...
const rules: Rule[] = [
  ...
  { sel: ".sus-saving", kind: "up", delay: 0, stagger: 90 },
  { sel: ".sus-how-row", kind: "up", delay: 0, stagger: 70 },
  { sel: ".sus-limits-title", kind: "rise", delay: 0 },
  { sel: ".sus-limits-list li", kind: "up", delay: 120, stagger: 70 },
  { sel: ".sus-pledge", kind: "up", delay: 0, stagger: 70 },
  { sel: ".sus-cross", kind: "up", delay: 0 },
  { sel: ".rep-kpi", kind: "up", delay: 0, stagger: 90 },
  { sel: ".rep-plot", kind: "fade", delay: 0 },
  { sel: ".rep-q", kind: "up", delay: 0, stagger: 80 },
  { sel: ".rep-pledge", kind: "up", delay: 0, stagger: 60 },
  { sel: ".rep-formula", kind: "up", delay: 0, stagger: 90 },
  { sel: ".rep-boundary-title", kind: "rise", delay: 0 },
  { sel: ".rep-boundary-list li", kind: "up", delay: 120, stagger: 70 },
  { sel: ".soc-pillar", kind: "up", delay: 0, stagger: 100 },
  { sel: ".soc-meter", kind: "up", delay: 0, stagger: 90 },
  { sel: ".soc-facet", kind: "fade", delay: 0, stagger: 120 },
  { sel: ".soc-def", kind: "up", delay: 0, stagger: 50 },
