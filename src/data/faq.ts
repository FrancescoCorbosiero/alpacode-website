...
export const faq: Record<Lang, FaqPageData> = {
  it: {
    ...
    faqs: [
      ...
      { q: "Avete pacchetti a prezzo fisso?", a: "Sì. Oltre ai lavori su misura abbiamo i nostri prodotti digitali — come Hive Commerce — e pacchetti pronti come Sito Pronto o Brand Kit, con un prezzo deciso prima di partire e niente sorprese. Li trovi nella pagina Prodotti: sono il modo più veloce e prevedibile per cominciare." },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: "Do you have fixed-price packages?", a: "Yes. Alongside bespoke work we have our own digital products — like Hive Commerce — and ready-made packages like Ready Site or Brand Kit, with a price agreed before we start and no surprises. You'll find them on the Products page: they're the fastest, most predictable way to get going." },
