  ...
  it: {
    ...
    list: [
      ...
      },
      {
        ...
        ptext:
          "Un sito istituzionale che trasmette autorevolezza e chiarezza: settori e servizi, convenzioni, angolo del consumatore e reclami, tutto navigabile. Un'architettura dei contenuti pensata per generare contatti qualificati nei comparti B2B.",
        ...
        attr: "— direzione, Cesana Brokers",
        tag: "2025 · WEB ISTITUZIONALE",
      },
    ],
  },
  en: {
    ...
    list: [
      ...
      },
      {
        ...
        attr: "— management, Cesana Brokers",
