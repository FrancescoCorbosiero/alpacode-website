  ...
  termini: {
    it: {
      ...
      sections: [
        ...
        { h: "Proprietà intellettuale", body: "<p>Il materiale realizzato su misura per il cliente diventa di sua proprietà al saldo del compenso pattuito. I prodotti standard di Alpacode (es. <em>Hive Commerce</em>, <em>Alpacode Pro Kit</em>, <em>Paco</em>) sono concessi in licenza secondo le condizioni specifiche del singolo prodotto.</p>" },
    ...
    en: {
      ...
      sections: [
        ...
        { h: "Intellectual property", body: "<p>Material produced bespoke for the client becomes their property upon full payment. Alpacode's standard products (e.g. <em>Hive Commerce</em>, <em>Alpacode Pro Kit</em>, <em>Paco</em>) are licensed under the specific terms of each product.</p>" },
